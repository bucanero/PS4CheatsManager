...
void Draw_UserCheatsMenu_Ani(save_list_t * list)
{
    ...
    for (ani = 0; ani < MENU_ANI_MAX; ani++)
    {
		...
		DrawHeader_Ani(list->icon_id, list->title, "Game List", APP_FONT_TITLE_COLOR, 0xffffffff, ani, 12);
...
{
	DrawHeader(list->icon_id, 0, list->title, "Game List", APP_FONT_TITLE_COLOR | 0xFF, 0xffffff00 | alpha, 0);
